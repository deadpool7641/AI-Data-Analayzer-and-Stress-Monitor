...
predictor = dlib.shape_predictor("datasets/facial/shape_predictor_68_face_landmarks.dat")
emotion_classifier = load_model("datasets/facial/_mini_XCEPTION.102-0.66.hdf5", compile=False)
